...
if($_GET['cat'] == "Engineering")
	...
	if(mysql_num_rows($sqlSelProd) >= 1){
		while($getProdInfo = mysql_fetch_array($sqlSelProd)){
			...
			<a href="productdetail.php?prodid='.$prodNo.'"><img src="images/product/'.$prodNo.'.jpg" alt="Product '.$prodNo.'" width="170" height="150" /></a>
			<h3>'.$prodName.'</h3>
			<p class="product_price">₹'.$prodPrice.'</p>
			<a href="logcheck.php?prodid='.$prodNo.'&user_id='.$raj.'" class="add_to_cart">Add to Cart</a></div>';		}
	}
...
<style>
.cantainer{background-color:#4321;}
</style>
<body id="home">

<div class="cantainer-fluid" style="background-color:#4321;">
	<div class="container">
    	<div class="row"><div class='col-lg-4'><h1><font color="#000000" size="+1"><img src='images/get1.png' style="opacity:0.78;" class="image-thumbnail"/></font></h1></div>
